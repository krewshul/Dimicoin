...
#if defined(NDEBUG)
# error "Diminutive cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Diminutive Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight+1 <= 7)
    {
        nSubsidy = 0 * COIN; // Secure Chain Checkpoints
