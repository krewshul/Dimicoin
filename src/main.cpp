...
const int64_t nHardforkTime = 1415750400; // 12 Nov 2014 00:00:00 GMT ignore /old 
const int64_t nHardforkTime2 = 1463263200; // 15 May 00:00:00 2016 UTC ignore /old
...
unsigned int GetStakeMinAge(int64_t nTime)
{
    ...
    if (nTime > nHardforkTime)
        return 60 * 60 * 24 * 2; //minimum age: 2 days

    return 60 * 60 * 24 * 365; // Maximum age: 365 days
}
...
int nBestHeight = -1;
int nStartPoSBlock = 6000; ///// start time of POS blocks Due to pos doing only around 5000 +- on day 3 
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {
        nSubsidy = 10000 * COIN; // Premine 6 percent of total MAX 200 000  
    }
        else if(pindexBest->nHeight+1 >= 2  && pindexBest->nHeight+1 <= 1000000)
    {
...
static int64_t MAX_MINT_PROOF_OF_STAKE_1 = 0.20 * COIN;	//20% annual stake
static int64_t MAX_MINT_PROOF_OF_STAKE_2 = 0.20 * COIN;	//20% annual stake
