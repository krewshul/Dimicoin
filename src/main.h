...
static const int LAST_POW_BLOCK = 87000000;
...
static const int64_t MIN_TX_FEE = 0.00005000 * COIN; //Normal TX Fee 
/** Fees smaller than this (in satoshi) are considered zero fee (for relaying) */
static const int64_t MIN_RELAY_TX_FEE = MIN_TX_FEE;
/** No amount larger than this (in satoshi) is valid */
static const int64_t MAX_MONEY = 200000 * COIN; //total of 250 k coins
...
inline int64_t FutureDriftV1(int64_t nTime) { return nTime + 10 * 60; } //up to 120 minutes from the future
inline int64_t FutureDriftV2(int64_t nTime) { return nTime + 10 * 60; } //up to 120 minutes from the future
