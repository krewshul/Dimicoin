...
{
    resize(850+95, 550);
    setWindowTitle(tr("Diminutive Coin DMI") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    if (!fUseBlackTheme)
    {
        ...
        {
            progressBar->setStyleSheet("QProgressBar { background-color: #e8e8e8; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #f5f5f5, stop: 1 orange); border-radius: 7px; margin: 0px; }");
        }
    }
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new QAction(QIcon(":/icons/overview"), tr("&Main Dashboard"), this);
    overviewAction->setToolTip(tr("Show general overview of wallet"));
    overviewAction->setCheckable(true);
    overviewAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_1));
    tabGroup->addAction(overviewAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Receive Coin"), this);
    receiveCoinsAction->setToolTip(tr("Show the list of addresses for receiving payments"));
    receiveCoinsAction->setCheckable(true);
    receiveCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(receiveCoinsAction);

    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Send Coin"), this);
    sendCoinsAction->setToolTip(tr("Send DMI coins to a Diminutive Coin address"));
    ...
    aboutAction = new QAction(tr("&About DMI Diminutive Coin"), this);
    ...
    optionsAction->setToolTip(tr("Modify configuration options for Diminutive Coin"));
