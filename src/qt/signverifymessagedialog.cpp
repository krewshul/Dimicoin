    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a DiminutiveCoin address (e.g. DgJKYsHctQfF8D8r6otTGxdnB6r311NvJf)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a DiminutiveCoin address (e.g. DgJKYsHctQfF8D8r6otTGxdnB6r311NvJf)"));
