...
void Shutdown()
{
    ...
    RenameThread("diminutive-shutoff");
...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: diminutive.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: diminutived.pid)") + "\n";
